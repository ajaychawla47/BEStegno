...
public class Steganograph
{
	...
	private static class AboutFrame extends JFrame implements ActionListener
	{
		...
		public AboutFrame()
		{
			...
			lblTitle= new MyJLabel("Smart Steganography", new Font("Arial", Font.PLAIN, 15), YELLOW, BLACK);
			lblName= new MyJLabel("By:Demo Demo", new Font("Monotype Corsiva", Font.PLAIN, 14), GREEN, BLACK);
			lblEmail= new MyJLabel("", GREEN, BLACK);
			lblPhone= new MyJLabel("", GREEN, BLACK);
			if(new File("Images/Logo.jpg").exists())
				lblImage= new JLabel(new ImageIcon("Images/Logo.jpg"));
			else
			{
				lblImage= new MyJLabel("", new Font("Times new roman", Font.PLAIN, 50), Color.red, Color.black);
	...
	public SteganoInformation(File file)
	{
		...
		if(fileExtension.equalsIgnoreCase("jpg"))
			inputMarker= Steganograph.OFFSET_JPG;
				...
				inputMarker= Steganograph.OFFSET_MP3;
		else if(fileExtension.equalsIgnoreCase("avi"))
				inputMarker= Steganograph.OFFSET_AVI;
			  else
