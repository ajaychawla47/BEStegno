...
public class BackEndHandler extends Thread
{
	...
	public BackEndHandler(WindowAdapter client, short operation)
	{
		...
		MyFileFilter filter3= new MyFileFilter(new String[]{"avi", "mpg"}, "Video files");
					...
					if(steg.isEster())
						...
						if(!steg.isValid())
							JOptionPane.showMessageDialog(null, "File '"+ masterFile.getName()+ 
								"' does not contain any message or file\nembedded using Seganograph", "Invalid Steganograph file!", JOptionPane.WARNING_MESSAGE);
						else
	...
	public boolean chooseOutputFile()
	{
		...
		do
		{
			...
			result= fileChooser.showDialog(null, "Name Output file");
			if(result== fileChooser.APPROVE_OPTION)
			{
